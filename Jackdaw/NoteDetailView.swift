...
struct NoteDetailView_Previews: PreviewProvider {
    static var previews: some View {
        TextFieldPreviewView(text: "Jackdaw\nA fine black and gray bird with pale eyes, related to but smaller than the carrion crow.\nThough thievish and mischievous to the farmer, the jackdaw is a curious and intelligent bird and, like its Corvid cousins, can use tools for complex problem solving.\nLike the magpie and mynah, the jackdaw collects and decorates its nest with bright objects. Owing to its supposed fondness for picking up coins, Linnaeus gave it the binomial name Corvus monedula, choosing the specific name mǒnēdŭla, which is derived from moneta, the Latin stem of the word \"money\".\nThe collective noun for a group is a \"clattering\" of jackdaws. They are gregarious and vocal birds and live in small groups with complex social structures.\nThe jackdaw call is a familiar hard 'tchack' from which it gets its name. It will commonly nest in chimneys, buildings, rock crevices and tree holes.")
            .padding()
    }
}
